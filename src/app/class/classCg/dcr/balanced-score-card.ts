export class BalancedScoreCard {
    ...
    mois!: string; dateGenere!: string; user_update!: string; last_update!: string; domaineCle!: string;
    valide!: string; userValide!: string; dateValidation!: string;
    note!: string; poids!: number; taux!: number; periode!: number;
    moyenne!: number; moyenne20!: number;
